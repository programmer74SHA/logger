...
// firewall service transient instance handler
func firewallServiceGetter(appContainer app.AppContainer) ServiceGetter[*service.FirewallService] {
	return func(ctx context.Context) *service.FirewallService {
