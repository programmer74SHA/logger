...
type ZoneInterface struct {
	...
	VlanTableId   string                 `protobuf:"bytes,2,opt,name=vlan_table_id,json=vlanTableId,proto3" json:"vlan_table_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ZoneInterface) Reset() {
	*x = ZoneInterface{}
...
func (x *ZoneInterface) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZoneInterface) ProtoMessage() {}

func (x *ZoneInterface) ProtoReflect() protoreflect.Message {
	mi := &file_firewall_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ZoneInterface.ProtoReflect.Descriptor instead.
func (*ZoneInterface) Descriptor() ([]byte, []int) {
	return file_firewall_proto_rawDescGZIP(), []int{1}
}

func (x *ZoneInterface) GetInterfaceId() string {
	if x != nil {
...
func (x *ZoneInterface) GetVlanTableId() string {
	if x != nil {
		return x.VlanTableId
	}
	return ""
}
...
type FirewallAsset struct {
	...
	Risk             string                 `protobuf:"bytes,11,opt,name=risk,proto3" json:"risk,omitempty"`
...
func (x *FirewallAsset) GetRisk() string {
	if x != nil {
		return x.Risk
	}
	return ""
...
type FirewallZone struct {
	...
	Interfaces            []*ZoneInterface       `protobuf:"bytes,10,rep,name=interfaces,proto3" json:"interfaces,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *FirewallZone) GetInterfaces() []*ZoneInterface {
	if x != nil {
		return x.Interfaces
	}
	return nil
...
type FirewallInterface struct {
	...
	ParentInterfaceId    string                 `protobuf:"bytes,9,opt,name=parent_interface_id,json=parentInterfaceId,proto3" json:"parent_interface_id,omitempty"`
...
func (x *FirewallInterface) GetParentInterfaceId() string {
	if x != nil {
		return x.ParentInterfaceId
	}
	return ""
}
...
type FirewallVLAN struct {
	...
	ParentInterface      string                 `protobuf:"bytes,7,opt,name=parent_interface,json=parentInterface,proto3" json:"parent_interface,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *FirewallVLAN) GetParentInterface() string {
	if x != nil {
...
type FirewallPolicy struct {
	...
	SrcZoneNames         []string               `protobuf:"bytes,4,rep,name=src_zone_names,json=srcZoneNames,proto3" json:"src_zone_names,omitempty"`
	DstZoneNames         []string               `protobuf:"bytes,5,rep,name=dst_zone_names,json=dstZoneNames,proto3" json:"dst_zone_names,omitempty"`
	SrcAddresses         []string               `protobuf:"bytes,6,rep,name=src_addresses,json=srcAddresses,proto3" json:"src_addresses,omitempty"`
	DstAddresses         []string               `protobuf:"bytes,7,rep,name=dst_addresses,json=dstAddresses,proto3" json:"dst_addresses,omitempty"`
	...
	Status               string                 `protobuf:"bytes,11,opt,name=status,proto3" json:"status,omitempty"`
	RuleOrder            int32                  `protobuf:"varint,12,opt,name=rule_order,json=ruleOrder,proto3" json:"rule_order,omitempty"`
	VendorSpecificConfig string                 `protobuf:"bytes,13,opt,name=vendor_specific_config,json=vendorSpecificConfig,proto3" json:"vendor_specific_config,omitempty"`
...
func (x *FirewallPolicy) GetSrcZoneNames() []string {
	if x != nil {
		return x.SrcZoneNames
	}
	return nil
}

func (x *FirewallPolicy) GetDstZoneNames() []string {
	if x != nil {
		return x.DstZoneNames
	}
	return nil
}
...
const file_firewall_proto_rawDesc = "" +
	...
	"cidrPrefix\x12 \n" +
	"\vallowaccess\x18\x04 \x03(\tR\vallowaccess\"V\n" +
	"\rZoneInterface\x12!\n" +
	"\finterface_id\x18\x01 \x01(\tR\vinterfaceId\x12\"\n" +
	"\rvlan_table_id\x18\x02 \x01(\tR\vvlanTableId\"\x88\x03\n" +
	...
	"\x04risk\x18\v \x01(\tR\x04risk\x12+\n" +
	...
	"\fadmin_status\x18\b \x01(\tR\vadminStatus\x12.\n" +
	"\x13parent_interface_id\x18\t \x01(\tR\x11parentInterfaceId\x12\x17\n" +
	"\avlan_id\x18\n" +
	...
	"\x16vendor_specific_config\x18\x06 \x01(\tR\x14vendorSpecificConfig\x12)\n" +
	"\x10parent_interface\x18\a \x01(\tR\x0fparentInterface\"\xd2\x03\n" +
	"\x0eFirewallPolicy\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vpolicy_name\x18\x02 \x01(\tR\n" +
	"policyName\x12\x1b\n" +
	"\tpolicy_id\x18\x03 \x01(\x05R\bpolicyId\x12$\n" +
	"\x0esrc_zone_names\x18\x04 \x03(\tR\fsrcZoneNames\x12$\n" +
	"\x0edst_zone_names\x18\x05 \x03(\tR\fdstZoneNames\x12#\n" +
	"\rsrc_addresses\x18\x06 \x03(\tR\fsrcAddresses\x12#\n" +
	"\rdst_addresses\x18\a \x03(\tR\fdstAddresses\x12\x1a\n" +
	"\bservices\x18\b \x03(\tR\bservices\x12\x16\n" +
	"\x06action\x18\t \x01(\tR\x06action\x12\x1f\n" +
	"\vpolicy_type\x18\n" +
	" \x01(\tR\n" +
	"policyType\x12\x16\n" +
	"\x06status\x18\v \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"rule_order\x18\f \x01(\x05R\truleOrder\x124\n" +
	"\x16vendor_specific_config\x18\r \x01(\tR\x14vendorSpecificConfig\x12\x1a\n" +
	"\bschedule\x18\x0e \x01(\tR\bschedule\"\x87\x02\n" +
	"\bFirewall\x12$\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\".\n" +
	"\x1aDeleteFirewallBatchRequest\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\tR\x03ids\"Q\n" +
	"\x1bDeleteFirewallBatchResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
...
var file_firewall_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_firewall_proto_goTypes = []any{
	(*SecondaryIP)(nil),                 // 0: SecondaryIP
	(*ZoneInterface)(nil),               // 1: ZoneInterface
...
var file_firewall_proto_depIdxs = []int32{
	1,  // 0: FirewallZone.interfaces:type_name -> ZoneInterface
